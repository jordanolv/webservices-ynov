...
import { ChevronLeft, ChevronRight, AlertCircle, RefreshCw, X } from 'lucide-react'
...
export default function Boutique() {
  ...
  const getProductHoverImage = (product: Product): string | undefined =>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {/* Image Container avec hover sur 2ème image */}
        ...
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <button
              ...
              className="absolute top-4 right-4 z-10 w-8 h-8 bg-white/90 hover:bg-white text-gray-900 rounded-full flex items-center justify-center shadow-lg transition-all duration-200 cursor-pointer"
            >
              <X className="w-4 h-4" />
            </button>
                  ...
                  {getProductImages(selectedProduct).length > 1 && (
                    <>
                      <button
                        ...
                        className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/90 hover:bg-white text-gray-900 rounded-full flex items-center justify-center shadow-lg transition-all duration-200 cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/90 hover:bg-white text-gray-900 rounded-full flex items-center justify-center shadow-lg transition-all duration-200 cursor-pointer"
                      >
                ...
                <div className="h-full flex flex-col">
                      ...
                      <div>
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className={`flex-1 px-4 py-3 rounded-lg font-medium transition-all duration-200 border cursor-pointer ${
                              selectedBorder === 'sans'
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-800">
                    ...
                    <div className="flex gap-3">
                      <button
                        onClick={() => setSelectedProduct(null)}
                        className="flex-1 border border-gray-700 text-gray-300 py-3 rounded-lg font-medium hover:bg-gray-800 transition-colors cursor-pointer"
                      >
                        Fermer
                      </button>
                      <button
